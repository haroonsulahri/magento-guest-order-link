...
- Polished public documentation and Admin-facing messages for clarity, accuracy and consistency.
...
- Enabled Magento modules before clean-install DI compilation in the Magento verification workflow.
